...
class Blah:
    ...
    async def event(self):
        ...
        embed.add_field(name="**Other information**", value="We want this to be a fun event! Let's try to keep this civil, friendly, and all tournament based discussion within the #event-chat channel. If you want to play this using Dolphin you must launch the game using your NAND (Dump NAND, extract to folder, set folder in Dolphin).")
