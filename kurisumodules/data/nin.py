...
ctrwup = {
    ...
    '002-0121': 'Local friend code SEED has invalid signature.\n\nThis should not happen unless it is modified. The '
                'only use case for modifying this file is for system unbanning, so you cannot ask how to fix this '
                'issue here.',
    ...
    '005-5602': 'Unable to connect to the eShop. This error is most likely the result of an incorrect region '
                'setting.\nMake sure your region is correctly set in System Settings. If you encounter this error '
                'after region-changing your system, make sure you followed all the steps properly.',
    '005-5964': 'Your Nintendo Network ID has been banned from accessing the eShop.\nIf you think this was '
                'unwarranted, you will have to contact Nintendo Support to have it reversed.',
    ...
    '006-0502': 'Could not connect to the server.\n\n• Check the [network status page]('
                'http://support.nintendo.com/networkstatus)\n• Move closer to your wireless router\n• Verify DNS '
                'settings. If "Auto-Obtain" doesn\'t work, try Google\'s Public DNS (8.8.8.8, 8.8.4.4) and try again.',
    ...
    '007-2100': 'The connection to the Nintendo eShop timed out.\nThis may be due to an ongoing server maintenance, '
                'check <https://support.nintendo.com/networkstatus> to make sure the servers are operating normally. '
                'You may also encounter this error if you have a weak internet connection.',
    '007-2404': 'An error occurred while attempting to connect to the Nintendo eShop.\nMake sure you are running the '
                'latest firmware, since this error will appear if you are trying to access the eShop on older '
                'versions.',
    '007-2720': 'SSL error?',
    ...
    '022-2501': "Attempting to use a Nintendo Network ID on one system when it is linked on another. This can be the "
                ...
                "services that require a Nintendo Network ID.\n\nIn a System Transfer, all Nintendo Network ID "
                "accounts associated with the system are transferred over, whether they are currently linked or not.",
    ...
    '022-2613': 'Incorrect e-mail or password when trying to link an existing Nintendo Network ID. Make sure there '
                ...
                'reset it at <https://id.nintendo.net/account/forgotten-password>',
