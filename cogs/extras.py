...
class Extras(commands.Cog):
    ...
    @commands.guild_only()
    @commands.command(hidden=True)
    async def userroles(self, ctx: commands.Context, u: discord.Member = commands.Author):
    ...
    @commands.command()
    async def nickme(self, ctx: commands.Context, *, nickname: str):
    ...
    @commands.command()
    async def remindme(self, ctx: commands.Context, remind_in: int = commands.parameter(converter=utils.DateOrTimeConverter), *, reminder: str):
