...
class Blah:
    ...
    async def event(self):
        ...
        embed.set_footer(text="dubyadud & FlamFlim69", icon_url="https://cdn.discordapp.com/avatars/186483213701611520/2d1a166be1ea984a4e3d1aed1ce897b4.webp?size=64")
        ...
        embed.add_field(name="**When**", value="Right now the Nintendo Homebrew discord staff, in cooperation with the Wiimmfi team, are deliberating on a date on when we can start the tourney. Users are encouraged to create their copy of Wiims Mario Kart Retro and register on the Wiimfi servers asap to ensure that the competition goes smoothely rather than widespread issues on the first day.")
        embed.add_field(name="**Assistance**", value="If you need any kind of help building your own copy of Wiims Mario Kart Retro, please refer to the #gamechat channel.")
        embed.add_field(name="**Other information**", value="We want this to be a fun event! Let's try to keep this civil, friendly, and all tournament based discussion within the #gamechat channel. If you want to play this using Dolphin you must launch the game using your NAND (Dump NAND, extract to folder, set folder in Dolphin).")
