...
class Rules:
    ...
    async def r11(self):
       """Quotes rule 11."""
       await self.bot.say("```11. Illegitimate copies and other copyright violations will not be tolerated. This includes: \n - Sharing full game data, such as .3DS/CCI or CIA files, \n - Sharing 'ticket' files, \n - Sharing encryption keys, \n - Linking to any site with the purpose of hosting or providing the above, \n - Openly admitting to piracy or copyright violations. \n - This also affects platforms other than the 3DS, including the PC, and copyrightable material such as software, music, or movies.```")
