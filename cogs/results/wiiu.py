...
act = Module('act (accounts)', {
    ...
    2800: ResultCode('Banned.'),
    2801: ResultCode('Account is banned.'),
    2802: ResultCode('Account is banned from all services.'),
    2803: ResultCode('Account is banned from a particular game.'),
    2804: ResultCode('Account is banned from Nintendo\'s online service.'),
    2805: ResultCode('Account is banned from independent services.'),
    2811: ResultCode('Console is banned.'),
    2812: ResultCode('Console is banned from all services.'),
    2813: ResultCode('Console is banned from a particular game.'),
    2814: ResultCode('Console is banned from Nintendo\'s online service.'),
    2815: ResultCode('Console is banned from independent services.'),
    2821: ResultCode('Account is temporarily banned.'),
    2822: ResultCode('Account is temporarily banned from all services.'),
    2823: ResultCode('Account is temporarily banned from a particular game.'),
    2824: ResultCode('Account is temporarily banned from Nintendo\'s online service.'),
    2825: ResultCode('Acccount is temporarily banned from independent services.'),
    2831: ResultCode('Console is temporarily banned.'),
    2832: ResultCode('Console is temporarily banned from all services.'),
    2833: ResultCode('Console is temporarily banned from a particular game.'),
    2834: ResultCode('Console is temporarily banned from Nintendo\'s online service.'),
    2835: ResultCode('Console is temporarily banned from independent services.'),
