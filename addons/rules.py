...
class Rules:
    ...
    async def nick(self):
        ...
        await self.bot.say("🏷 ___Username/Nickname and Avatar policy___\n"
                           ...
                           "Usernames that go against these rules will be assigned a nickname. Users can request a specific nickname in <#270890866820775946> or by DMing <@333857992170536961> that follows these rules.\n"
