...
3. To access the Homebrew Launcher on the new console, perform a temporary manual homebrew swap (https://3ds.hacks.guide/troubleshooting#other-troubleshooting)(https://3ds.hacks.guide/finalizing-setup.html)
