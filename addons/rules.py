...
class Rules:
    ...
    async def r14(self):
        """Displays rule 14."""
        await self.simple_embed("Off-topic content goes to <#277529766972620800>. Keep low-quality content like memes out. There is a channel for that, use \".togglechannel elsewhere\" to get access.", title="Rule 14")
