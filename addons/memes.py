...
class Memes:
    ...
    async def _meme(self, ctx, msg):
        ...
        if ctx.message.channel.name[0:5] == "help-" or "assistance" in ctx.message.channel.name or (self.bot.nomemes_role in author.roles) | (self.bot.noembed_role in author.roles):
