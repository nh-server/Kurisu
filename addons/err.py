...
class Err:
    ...
    errcodes = {
        ...
        '002-0123': 'Game Card is banned by Nintendo or ROM ID illegal, if it was unwaranted, contact Nintendo for this to be reversed, otherwise you cannot ask how to fix this issue here.',
        '002-0124': 'Game Card is banned by Nintendo or game info not registered into server, if it was unwaranted, contact Nintendo for this to be reversed. You cannot ask how to fix this issue here.
        '002-0125': 'Game Card is banned by Nintendo or authorziation failure, if it was unwaranted, contact Nintendo for this to be reversed. You cannot ask how to fix this issue here.
        ...
        '015-1008': 'NNID banned from Miiverse.',
        '015-5007': 'NNID banned from Miiverse until system messages are read.',
        '015-5008':	'NNID banned from posting in Miiverse until system messages are read.',
        '015-5009': 'System banned from Miiverse until system messages are read.',
        '015-5010': 'System banned from posting in Miiverse until system messages are read.',
        '015-1009': 'System banned from Miiverse.',
        ...
        '022-2801': 'System banned from NNID services.',
        '022-2802': 'NNID is permanently banned from all services.',
        '022-2803': 'NNID is permanently banned from certain services.',
        '022-2804': 'NNID is permanently banned from specific game server ID.',
        '022-2805': 'NNID is permanently banned from certain service (using Client ID).
        '022-2812': 'All network services on this system are permanently banned by Nintendo. You cannot ask how to fix this issue here.',
        '022-2813': 'Device is banned from certain services.',
        '022-2814': 'Device is banned from specific game server ID.',
        '022-2815': 'System is banned from Miiverse access.',
        '022-2821': 'NNID is temporarily banned from all services.',
        '022-2823': 'NNID is temporarily banned from certain services.',
        '022-2824': 'NNID is temporarily banned from specific game server ID.',
        '022-2825': 'NNID is temporarily banned from certain service (using Client ID)'.,
        '022-2832': 'System is temporarily banned from all services. You cannot ask how to fix this issue here.',
        '022-2833': 'System is temporarily banned from certain services. You cannot ask how to fix this issue here.',
        '022-2834': 'System is temporarily banned from specific game server ID. You cannot ask how to fix this issue here.',
        '022-2835': 'System is temporarily banned from certain service (using Client ID). You cannot ask how to fix this issue here.',
        ...
        '102-2802': 'NNID is permanently banned from all services. You cannot ask how to fix this issue here.',
        '102-2803': 'NNID is permanently banned from certain software.'
        '102-2804': 'NNID is permanently banned from specific game server ID.',
        '102-2805': 'System is banned from accessing Nintendo eShop. You cannot ask how to fix this issue here.',
        '102-2812': 'System is permanently banned from all online services. You cannot ask how to fix this issue here.',
        '102-2813': 'System is permanently banned from certain software. You cannot ask how to fix this issue here.',
        '102-2814': 'System is permanently banned from specific game server ID. You cannot ask how to fix this issue here.',
        ...
        '102-2822': 'NNID is temporarily banned by Nintendo. You cannot ask how to fix this issue here.',
        '102-2823': 'NNID is temporarily banned from certain software.'
        '102-2824': 'NNID is temporarily banned from specific game server ID.',
        '102-2825': 'NNID is temporarily banned from certain service (using Client ID).',
        '102-2832': 'System is temporarily banned from all online services. You cannot ask how to fix this issue here.',
        '102-2833': 'System is temporarily banned from certain software. You cannot ask how to fix this issue here.',
        '102-2834': 'System is temporarily banned from specific game server ID. You cannot ask how to fix this issue here.',
        '102-2835': 'System is temporarily banned accessing the Nintendo eShop. You cannot ask how to fix this issue here.',
    ...
    switch_errcodes = {
        ...
        '2124-4007': ['System is permanently banned by Nintendo. You cannot ask how to fix this issue here.', None],
        ...
        '2124-4027': ['System + Nintendo Account are banned from online multiplayer services in certain software (preferably Splatoon 2). You cannot ask how to fix this issue here.', None],
